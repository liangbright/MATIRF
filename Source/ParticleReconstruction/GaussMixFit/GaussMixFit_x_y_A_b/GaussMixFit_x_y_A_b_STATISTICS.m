function [A_std MSE]=GaussMixFit_x_y_A_b_STATISTICS(Param, ParticleNum, R, I_Data, XPixelList, YPixelList)

[F J Iobj_model Ib_model]=GaussMixFit_x_y_A_b_FitErr_NoPrior(Param, ParticleNum, R, I_Data, XPixelList, YPixelList);
%%
...
if ~isempty(IdxListP)
    ...
    IdxList=[IdxListP ParticleNum+IdxListP  2*ParticleNum+IdxListP  3*ParticleNum+IdxListP];
    subJ=J(:, IdxList);
