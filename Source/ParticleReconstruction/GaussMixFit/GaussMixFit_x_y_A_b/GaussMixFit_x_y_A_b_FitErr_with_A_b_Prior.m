function [F J Iobj Ib]=GaussMixFit_x_y_A_b_FitErr_with_A_b_Prior(Param, ParticleNum, R, I_Data, X, Y, ...
...
J=zeros(2*PixelNum+ParticleNum, 4*ParticleNum);
%%
