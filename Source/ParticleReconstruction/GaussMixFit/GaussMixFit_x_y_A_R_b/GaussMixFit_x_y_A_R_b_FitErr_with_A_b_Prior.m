function [F J Iobj Ib]=GaussMixFit_x_y_A_R_b_FitErr_with_A_b_Prior(Param, ParticleNum, I_Data, X, Y, ...
...
J=zeros(2*PixelNum+ParticleNum, 5*ParticleNum);
%%
...
dFdR=zeros(2*PixelNum+ParticleNum,ParticleNum);    
dFdb=zeros(2*PixelNum+ParticleNum,ParticleNum);
